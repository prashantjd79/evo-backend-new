...
const { postJob, reviewJob, getEmployerJobs,getStudentDetailsById,applyForJob, getJobApplicants,registerEmployer,loginEmployer } = require("../controllers/jobController");
